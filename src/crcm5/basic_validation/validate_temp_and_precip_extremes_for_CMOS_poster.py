...
from crcm5.basic_validation.plot_area_averages_CMOS_poster import plot_area_avg_CMOS_poster
...
def main():
    ...
    data_dict = {vn: OrderedDict() for vn in varnames_list}
    bias_dict = {vn: OrderedDict() for vn in varnames_list}
    ...
    for vn in data_dict:
        ...
        plot_area_avg_CMOS_poster(data_dict[vn], bias_dict[vn], panel_titles=(vn, ""), img_dir=img_folder / "extremes_1d")
