...
def export_static_fields_to_hdf():
    ...
    dm.export_static_fields_to_hdf(file_path = hdf_file)
    pass
...
def main():
    ...
    #latest interflow
    data_folder = "/home/huziy/skynet3_rech1/from_guillimin/new_outputs/quebec_0.1_crcm5-hcd-rl-intfl_spinup4/all_in_one_folder"


    dm = Crcm5ModelDataManager(samples_folder_path = data_folder, all_files_in_samples_folder=True)
    var_names = ["STFL", "PR", "TT", "AV", "AH", "TRAF", "TDRA", "I5", "I0", "I1", "I2", "IMAV"]
    dm.export_to_hdf(var_list = var_names,
                     file_path="/home/huziy/skynet3_rech1/hdf_store/quebec_0.1_crcm5-hcd-rl-intfl_spinup4.hdf",
        mode="a")
    pass
