...
from lake_effect_snow.hles_cc import common_params as common_params_cc
...
def main():
    ...
    img_dir = common_params_cc.img_folder
    ...
    label_to_hles_dir = OrderedDict(
        [
         ...
         ("GEM_NEMOc", data_root /"lake_effect_analysis_CRCM5_NEMO_1980-2009_monthly"),
