...
def main(varname=""):
    ...
    label_to_datapath = OrderedDict([
        ...
        (common_params.crcm_nemo_cur_label, data_root / "lake_effect_analysis_CRCM5_HL_CanESM2_RCP85_1989-2010_1989-2010"),
        (common_params.crcm_nemo_fut_label, data_root / "lake_effect_analysis_CRCM5_HL_CanESM2_RCP85_2079-2100_2079-2100"),
    ])
