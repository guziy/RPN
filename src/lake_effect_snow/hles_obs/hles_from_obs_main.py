...
def __obs_case_monthly(period, vname_to_level: dict, vname_map: dict, label: str, base_dir: str, nprocs: int = 4):
    """
...
def generate_hles_obs_variants():
    ...
    common_dir = Path("/home/data/big1/obs_data_for_HLES/interploated_to_the_same_grid/")
    ...
    for label, base_folder in label_to_base_folder.items():
        __obs_case_monthly(period, vname_to_level_erai, vname_map, label, base_folder)
