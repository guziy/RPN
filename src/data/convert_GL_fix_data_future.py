...
def parallel_conversion_entry():
    ...
    # label_to_simpath[f"CanESM2_GL_{start_year}-{end_year}"] = "/scratch/huziy/Output/GL_CC_CanESM2_RCP85/coupled-GL-future_CanESM2/Samples"
    label_to_simpath[f"CanESM2_GL_{start_year}-{end_year}"] = "/home/huziy/data/big1/Projects/HLES_GL_NEMO_CRCM5_CC/coupled-GL-future_CanESM2/Samples"
